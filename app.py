...
from utils.text_clean import clean_text, clean_text_spacy
from utils.nlp_functions import show_wordcloud , plot_top_ngrams_bar_chart,detect_emotions,detect_overall_sentiment_avg,classify_custom,summarize_large_text
...
if a=="Process Csv file":
    ...
    if uploaded_file is not None:
        ...
        st.header("Choose filtering opetion.")
        ...
        if selected_value:
           ...
           st.divider()
           text = " ".join(filtered_df.astype(str).values.flatten())
